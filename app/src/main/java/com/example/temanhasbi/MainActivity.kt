...
import com.example.temanhasbi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        when (p0?.getId()){
            R.id.save ->    { val getUserID = auth!!.currentUser!!.uid
                ...
                if (isEmpty(getNama) || isEmpty(getAlamat) || isEmpty(getNoHP)){
                    ...
                    getReference.child("Admin").child(getUserID).child("Teman Hasbi").push()
            ...
            R.id.show_data -> {startActivity(Intent(this@MainActivity, MyListData::class.java))}
        }
    }
}